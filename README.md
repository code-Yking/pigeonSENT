...
This project had several vulnerabilities that my young self did not properly scrutinize, and presents itself as a relic on how NOT to store user information.
