...
echo  "Full Name: ". $_SESSION["name"];
   echo "<br>Username: ". $_SESSION['contact'] . ".<br> <a class='mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored' href='http://pigeonsent.ueuo.com/contacts/add_contact.php'>
